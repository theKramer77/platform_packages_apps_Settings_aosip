...
public class SwitchStylerPreferenceController extends AbstractPreferenceController implements
        Preference.OnPreferenceChangeListener {

    private static final String SWITCH_STYLER = "switch_styler";
    private ListPreference mSwitchStyle;

    public SwitchStylerPreferenceController(Context context) {
        super(context);
    }

    @Override
    public String getPreferenceKey() {
        return SWITCH_STYLER;
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mSwitchStyle = (ListPreference) screen.findPreference(SWITCH_STYLER);
        int switchStyle = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.SWITCH_STYLER, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mSwitchStyle) {
            ...
            Settings.System.putInt(mContext.getContentResolver(), Settings.System.SWITCH_STYLER, Integer.valueOf(value));
